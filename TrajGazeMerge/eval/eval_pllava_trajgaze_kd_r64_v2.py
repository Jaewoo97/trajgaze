"""
Standalone eval for TrajGazeMerge (10% tokens) + PLLaVA LoRA r=64 (KD v2, epoch_01).
Loads epoch_01.pth (lora_state + encoder_state) and runs merged-token generation eval on egtea.

Usage:
    CUDA_VISIBLE_DEVICES=0 python -m TrajGazeMerge.eval.eval_pllava_trajgaze_kd_r64_v2 \
        --ckpt /workspace/EgoGazeVQA/TrajGazeMerge/checkpoints/pllava_trajgaze_kd_r64_v2/epoch_01.pth \
        --output /workspace/EgoGazeVQA/TrajGazeMerge/eval_results/pllava_trajgaze_kd_r64_v2_epoch01_metrics.json
"""
...
def load_model_and_encoder(ckpt_path, device):
    ...
    if encoder_state is not None:
        ...
        print("[TrajEnc] WARNING: no encoder_state in ckpt, using stage1 init")
...
def main():
    ...
    p.add_argument("--output", default="/workspace/EgoGazeVQA/TrajGazeMerge/eval_results/pllava_trajgaze_kd_r64_v2_epoch01_metrics.json")
    ...
    result = {
        "model": "pllava_trajgaze_kd_r64_v2_epoch01",
        "ckpt": args.ckpt,

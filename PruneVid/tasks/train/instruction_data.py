...
data_root = "DATAS/"
anno_root_it = "DATAS/TRAIN_TEST/magic_jsons"
...
available_corpus = dict(
    ...
    # video
    sharegpt4view_caption=[
        f"{anno_root_it}/video/caption/sharegpt4video/train.json", 
        f"{data_root}",
        "video"
    ],
    conversation_videochatgpt=[
        f"{anno_root_it}/video/conversation/videochatgpt/train_new_1.json", 
        f"{data_root}/Video_ChatGPT", # no
        "video"
    ],
    # vcg_plus=[
    #     f"{anno_root_it}/video/vcg112k-plus/vcg-plus_112K_new.json",
    #     f"{data_root}/Video_ChatGPT",
    #     "video"
    # ],
    # caption_textvr=[
    #     f"{anno_root_it}/video/caption/textvr/train.json", 
    #     f"{data_root}/TextVR_data/Video",
    #     "video"
    # ],
    # caption_videochat=[
    #     f"{anno_root_it}/video/caption/videochat/train_new.json", 
    #     "/root/paddlejob/workspace/env_run/data_afs_3/zhouhao14/intern/xiaohu/webvid/webvid",
    #     "video"
    # ], # not ready, need to read from hdfs
    # caption_webvid=[
    #     f"{anno_root_it}/video/caption/webvid/train_new.json", 
    #     "/root/paddlejob/workspace/env_run/data_afs_3/zhouhao14/intern/xiaohu/webvid/webvid",
    #     "video"
    # ], # not ready, need to read from hdfs
    # caption_youcook2=[
    #     f"{anno_root_it}/video/caption/youcook2/train.json", 
    #     f"{data_root}/YouCook2/split_videos",
    #     "video"
    # ],
    classification_k710=[
        f"{anno_root_it}/video/classification/k710/mv_prompt.json", 
        f"{data_root}/k710",
        "video"
    ],
    classification_ssv2=[
        f"{anno_root_it}/video/classification/ssv2/mv_prompt.json", 
        f"{data_root}/ssv2",
        "video"
    ],
    # conversation_videochat1=[
    #     f"{anno_root_it}/video/conversation/videochat1/train_new.json", 
    #     "/root/paddlejob/workspace/env_run/data_afs_3/zhouhao14/intern/xiaohu/webvid/webvid",
    #     "video"
    # ],# not ready, need to read from hdfs
    conversation_videochat2=[
        f"{anno_root_it}/video/conversation/videochat2/train.json", 
        f"{data_root}/videochat2_conversation_videos",
        "video"
    ],
    reasoning_next_qa=[
        f"{anno_root_it}/video/reasoning/next_qa/train.json", 
        f"{data_root}/NExTVideo",
        "video"
    ],
    ...
    vqa_ego_qa=[
        ...
        f"{data_root}/ego4d_data/split_videos",
        "video"
    ],
    # vqa_tgif_frame_qa=[
    #     f"{anno_root_it}/video/vqa/tgif_frame_qa/train.json", 
    #     "/root/paddlejob/workspace/env_run/output/xiaohu/data/video_vlm/PLLaVA/DATAS/VideoQA/TGIF_QA/videos_mp4",
    #     "video"
    # ],
    ...
    # ],
    vqa_webvid_qa=[
        f"{anno_root_it}/video/vqa/webvid_qa/train_new.json", 
        "/root/paddlejob/workspace/env_run/data_afs_3/zhouhao14/intern/xiaohu/webvid/webvid",
        "video"
    ],# not ready, need to read from hdfs
    # origin_videochatgpt=[
...
available_corpus["videochat2_video"] = [
    ...
    # available_corpus["conversation_videochat2"],
    # available_corpus["conversation_videochatgpt"],
    available_corpus['sharegpt4view_caption'],
    # available_corpus['vcg_plus'],
    # available_corpus["reasoning_next_qa"],
    # available_corpus["reasoning_clevrer_qa"],
    # available_corpus["reasoning_clevrer_mc"],
    # available_corpus["vqa_ego_qa"],
...
# Register StreamGaze_v2 EgoExoLearn+HoloAssist train (EGTEA held out for eval).

"""
Evaluate NVILA-8B-HD-Video (without AutoGaze) on StreamGaze
...
Usage:
  /workspace/vila_eval_env/bin/python eval/eval_nvila.py \
...
def load_model():
    print("Loading NVILA processor (no AutoGaze: gazing_ratio=1.0) ...")
...
def main():
    ...
    parser.add_argument("--output",
                        default="results/present_future_action_prediction/nvila_no_autogaze",
    ...
    save_results(results, out_dir, "nvila_no_autogaze",
                 extra={"model": "NVILA-HD-Video-no-autogaze", "skipped": skipped})
